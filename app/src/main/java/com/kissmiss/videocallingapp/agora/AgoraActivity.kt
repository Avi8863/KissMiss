package com.kissmiss.videocallingapp.agora
...
import com.kissmiss.videocallingapp.agora.media.RtcTokenBuilder2
import com.kissmiss.videocallingapp.databinding.ActivityAgoraBinding
    ...
    fun leaveChannel(view: View) {
        if (!isJoined) {
           // showMessage("Join a channel first")
            ...
            isJoined = false
            val intent = Intent(this@AgoraActivity, MainActivity::class.java)
